...
def _collect_daemon_health(ssh):
    ...
    health = {}
    for unit in ("wedge100s-i2c-poller.timer", "wedge100s-bmc-poller.timer",
                 "wedge100s-i2c-poller.service", "wedge100s-bmc-poller.service"):
...
def test_generate_platform_status_report(ssh):
    ...
    lines.append(f"**Generated by:** stage_18_report/test_report.py")
    lines.append("")

...
struct attrs *wedge100s_cmn_list[] = {
    &wedge100s_common[CMN_VERSION],
    &wedge100s_common[CMN_ACCESS],
    &wedge100s_common[CMN_PRESENT_ALL],
    NULL
};
...
struct attrs *wedge100s_port_list[] = {
    &wedge100s_port[SFP_PRESENT],
    &wedge100s_port[SFP_RESET],
    NULL
};
...
struct model_attrs models_attr[NUM_MODEL] = {
    {.cmn = wedge100s_cmn_list, .portly=wedge100s_port_list},
    {.cmn = wedge100s_cmn_list, .portly=wedge100s_port_list}, /*7716's as 7712*/
